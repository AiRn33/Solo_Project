            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                    	<!-- 상위 메뉴바 -->
                        <li class="nav-item"><a class="nav-link me-lg-3" href="#features">Test1</a></li>
                        <li class="nav-item"><a class="nav-link me-lg-3" href="#download">Test2</a></li>
                    </ul>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-5 mb-lg-0 text-center text-lg-start">
                            ...
                            <p class="lead fw-normal text-muted mb-5">
                            	안되면 될 때까지 수단과 방법을 가리지 않는 개발자가 되겠습니다
                            </p>
                            <div class="d-flex flex-column flex-lg-row align-items-center">
                            	<a href="#" class="nav-link me-lg-3">나는 노력중!!</a>
                            	<a href="#" class="nav-link me-lg-3">나는 노력중!!</a>
                            	<a href="#" class="nav-link me-lg-3">나는 노력중!!</a>
                            </div>
                        </div>
